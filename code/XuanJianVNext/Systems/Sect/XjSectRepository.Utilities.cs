...
{		private static string SafeActorName(Actor actor)
		{
			...
			catch (System.Exception xjCaught27_1)
			{
				XuanJianVNext.Core.XjExceptionDiagnostics.Report("code/XuanJianVNext/Systems/Sect/XjSectRepository.Utilities.cs:27", xjCaught27_1);
		...
		private static string SafeDataName(BaseSystemData data, string fallback)
		{
			...
			catch (System.Exception xjCaught45_2)
			{
				XuanJianVNext.Core.XjExceptionDiagnostics.Report("code/XuanJianVNext/Systems/Sect/XjSectRepository.Utilities.cs:45", xjCaught45_2);
