...
internal static class XjYinSiTraitLifecycle
{
	...
	{
		// 阴司实体生成已永久关闭；background.yinsi 这里只保留旧运行态的低频清理。
		// 旧实现会先 Clear pending-spawn 容器再检查 Count，属于不可达死逻辑，
		// 在新的阴司终局队列活跃期间没有必要每帧执行一轮无效扫描。
		PruneTransientRuntimeState(Time.unscaledTime);
	}

	internal static void ForgetActorRuntime(long actorId)
	{
		if (actorId <= 0L) return;
		PendingSpawnDueTimeByYaoXieId.Remove(actorId);
		PendingSpawnRetryCountByYaoXieId.Remove(actorId);
		LastBindAttemptTimeByYaoXieId.Remove(actorId);
		LastCompleteBindTimeByYaoXieId.Remove(actorId);
		LastMissionAggroTimeByYinSiId.Remove(actorId);
	}
	...
	private static void PurgeWorldlyTies(Actor actor)
	{
		...
		try { isKingdomCiv = actor.isKingdomCiv(); } catch (System.Exception xjCaught395) { XuanJianVNext.Core.XjExceptionDiagnostics.Report("code/XuanJianVNext/Systems/Cultivation/XjYinSiTraitLifecycle.cs:395", xjCaught395); }
		...
		try { actor.setCity(null); } catch (System.Exception xjCaught408) { XuanJianVNext.Core.XjExceptionDiagnostics.Report("code/XuanJianVNext/Systems/Cultivation/XjYinSiTraitLifecycle.cs:408", xjCaught408); }
		try { actor.setKingdom(null); } catch (System.Exception xjCaught409) { XuanJianVNext.Core.XjExceptionDiagnostics.Report("code/XuanJianVNext/Systems/Cultivation/XjYinSiTraitLifecycle.cs:409", xjCaught409); }
		try
		{
		...
		catch (System.Exception xjCaught421) { XuanJianVNext.Core.XjExceptionDiagnostics.Report("code/XuanJianVNext/Systems/Cultivation/XjYinSiTraitLifecycle.cs:421", xjCaught421); }
	}
	...
	private static string SafeActorName(Actor actor, string fallback)
	{
		...
		catch (System.Exception xjCaught438_5)
		{
			XuanJianVNext.Core.XjExceptionDiagnostics.Report("code/XuanJianVNext/Systems/Cultivation/XjYinSiTraitLifecycle.cs:438", xjCaught438_5);
	...
	private static void EnsureFixedYinSiSubspecies(Actor actor)
	{
		...
		catch (System.Exception xjCaught474) { XuanJianVNext.Core.XjExceptionDiagnostics.Report("code/XuanJianVNext/Systems/Cultivation/XjYinSiTraitLifecycle.cs:474", xjCaught474); }
	}
	...
	private static Subspecies ResolveYinSiHumanSubspecies(Actor actor)
	{
		...
		catch (System.Exception xjCaught518) { XuanJianVNext.Core.XjExceptionDiagnostics.Report("code/XuanJianVNext/Systems/Cultivation/XjYinSiTraitLifecycle.cs:518", xjCaught518); }
	...
	private static Subspecies TryFindNativeHumanSubspecies(Actor self)
	{
		...
		catch (System.Exception xjCaught552) { XuanJianVNext.Core.XjExceptionDiagnostics.Report("code/XuanJianVNext/Systems/Cultivation/XjYinSiTraitLifecycle.cs:552", xjCaught552); }
	...
	private static bool IsNativeHumanSubspecies(Subspecies subspecies)
	{
		...
		catch (System.Exception xjCaught585_9)
		{
			XuanJianVNext.Core.XjExceptionDiagnostics.Report("code/XuanJianVNext/Systems/Cultivation/XjYinSiTraitLifecycle.cs:585", xjCaught585_9);
	...
	private static bool IsYinSiHumanSubspecies(Subspecies subspecies)
	{
		...
		catch (System.Exception xjCaught599_10)
		{
			XuanJianVNext.Core.XjExceptionDiagnostics.Report("code/XuanJianVNext/Systems/Cultivation/XjYinSiTraitLifecycle.cs:599", xjCaught599_10);
	...
	private static void TryGeneratePhenotype(Actor actor)
	{
		...
		catch (System.Exception xjCaught620) { XuanJianVNext.Core.XjExceptionDiagnostics.Report("code/XuanJianVNext/Systems/Cultivation/XjYinSiTraitLifecycle.cs:620", xjCaught620); }
	}
	...
	private static void PrepareYinSiRuntimeAi(Actor actor)
	{
		...
		try { actor.setProfession(UnitProfession.Unit, true); } catch (System.Exception xjCaught632) { XuanJianVNext.Core.XjExceptionDiagnostics.Report("code/XuanJianVNext/Systems/Cultivation/XjYinSiTraitLifecycle.cs:632", xjCaught632); }
		try { actor.cancelAllBeh(); } catch (System.Exception xjCaught633) { XuanJianVNext.Core.XjExceptionDiagnostics.Report("code/XuanJianVNext/Systems/Cultivation/XjYinSiTraitLifecycle.cs:633", xjCaught633); }
		try { actor.clearOldPath(); } catch (System.Exception xjCaught634) { XuanJianVNext.Core.XjExceptionDiagnostics.Report("code/XuanJianVNext/Systems/Cultivation/XjYinSiTraitLifecycle.cs:634", xjCaught634); }
		try { actor.stopMovement(); } catch (System.Exception xjCaught635) { XuanJianVNext.Core.XjExceptionDiagnostics.Report("code/XuanJianVNext/Systems/Cultivation/XjYinSiTraitLifecycle.cs:635", xjCaught635); }
	}
	...
	private static void RefreshActor(Actor actor)
	{
		...
		catch (System.Exception xjCaught646) { XuanJianVNext.Core.XjExceptionDiagnostics.Report("code/XuanJianVNext/Systems/Cultivation/XjYinSiTraitLifecycle.cs:646", xjCaught646); }
	}
	...
	private static bool IsAlive(Actor actor)
	{
		...
		catch (System.Exception xjCaught663_17)
		{
			XuanJianVNext.Core.XjExceptionDiagnostics.Report("code/XuanJianVNext/Systems/Cultivation/XjYinSiTraitLifecycle.cs:663", xjCaught663_17);
	...
	private static bool ActorHasTrait(Actor actor, string traitId)
	{
		...
		catch (System.Exception xjCaught675_18)
		{
			XuanJianVNext.Core.XjExceptionDiagnostics.Report("code/XuanJianVNext/Systems/Cultivation/XjYinSiTraitLifecycle.cs:675", xjCaught675_18);
	...
	private static long GetActorId(Actor actor)
	{
		...
		catch (System.Exception xjCaught687_19)
		{
			XuanJianVNext.Core.XjExceptionDiagnostics.Report("code/XuanJianVNext/Systems/Cultivation/XjYinSiTraitLifecycle.cs:687", xjCaught687_19);
