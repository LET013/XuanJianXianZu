...
{		private static XjGuoWeiRegistryEntry NormalizeActiveHistoryEntry(in XjGuoWeiRegistryEntry entry)
		...
		private static string ResolveFamilyName(Actor actor)
		{
			...
			catch (System.Exception xjCaught151_1)
			{
				XuanJianVNext.Core.XjExceptionDiagnostics.Report("code/XuanJianVNext/Systems/HighRealm/XjGuoWeiRegistry.Utilities.cs:151", xjCaught151_1);
