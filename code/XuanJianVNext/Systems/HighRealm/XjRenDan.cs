...
internal static class XjRenDanRules
{
	...
	internal const float ZiFuRenDanChance = 0.30f;
	...
	{
		return "人丹：紫府在第4/第5神通前暗中选定其他家族的同道途筑基下修并施展续途妙法；事件可能成功、被旁人截走或遭掺假，成功所得神通求金时成功率-15%；污染结果会留下隐藏污染标记并使命定求金失败。";
	}
}
...
internal static partial class XjRenDan
{
	...
	{
		string year = state.Year > 0 ? state.Year.ToString(CultureInfo.InvariantCulture) + "年" : "未知年份";
