...
internal static class XjChronicleEventTypes
{
	...
	internal const string YuYiSucceeded = "YuYiSucceeded";
...
internal sealed class XjFamilyChronicleMemory
{
	...
	internal bool ContainsEventKey(string eventKey)
	{
		return !string.IsNullOrWhiteSpace(eventKey) && eventKeys.Contains(eventKey.Trim());
	}
