...
/// </summary>
internal readonly struct XjZongMenCityTraitState
{
	...
	internal XjZongMenCityTraitState(int scaleLevel, int spiritVeinLevel, int formationLevel, string environmentState)
	{
...
internal static class XjZongMenCityTraitAccessor
{
	...
	internal static XjZongMenCityTraitState BuildState(City city)
	{
		...
		return new XjZongMenCityTraitState(scaleLevel, spiritVeinLevel, formationLevel, environmentState);
	}
	...
	internal static void WriteState(City city, in XjZongMenCityTraitState state)
	{
		if (city?.data == null) return;
