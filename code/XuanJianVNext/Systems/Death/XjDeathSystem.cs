...
internal static class XjZiFuFailureDeathExecutor
{
	...
	internal static void TryExecute(Actor actor)
	{
		...
		catch (System.Exception xjCaught176_1)
		{
			XuanJianVNext.Core.XjExceptionDiagnostics.Report("code/XuanJianVNext/Systems/Death/XjDeathSystem.cs:176", xjCaught176_1);
...
internal static class XjRenDanDeathExecutor
{
	...
	internal static void TryExecute(Actor actor)
	{
		...
		catch (System.Exception xjCaught296_2)
		{
			XuanJianVNext.Core.XjExceptionDiagnostics.Report("code/XuanJianVNext/Systems/Death/XjDeathSystem.cs:296", xjCaught296_2);
...
internal static class XjQiYuDongTianDeathExecutor
{
	...
	internal static void TryExecute(Actor actor)
	{
		...
		catch (System.Exception xjCaught407_3)
		{
			XuanJianVNext.Core.XjExceptionDiagnostics.Report("code/XuanJianVNext/Systems/Death/XjDeathSystem.cs:407", xjCaught407_3);
