...
internal static class XjThreeBookDiagnostics
{
	...
	internal static XjCodexThreeBookHealth BuildHealth()
	{
		...
		return new XjCodexThreeBookHealth
		{
			...
			NativePartnerChecks = XjNativeRelationshipBridge.Attempts,
			NativePartnerDataKeyHits = XjNativeRelationshipBridge.ResolvedByDataKey,
			NativePartnerReflectionHits = XjNativeRelationshipBridge.ResolvedByReflection,
			NativePartnerMisses = XjNativeRelationshipBridge.Unresolved,
	...
	internal static void Clear()
	{
		...
		XjNativeRelationshipBridge.ClearDiagnostics();
	}
