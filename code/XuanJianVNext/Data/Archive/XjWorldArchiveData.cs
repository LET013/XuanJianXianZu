...
{
	public int Version { get; set; } = 126;
	...
	// 0.9.9.19：严格周期游标。SpawnCount 只在真实显化成功后递增；CadenceYears
	// 记录当时使用的配置周期，便于改滑块或读旧档时有界迁移，不再沿用旧的随机 nextYear。
	public int QiYuDongTianSpawnCount { get; set; }
	public int QiYuDongTianCadenceYears { get; set; }
	...
	public List<XjSectMemberArchiveRecord> SectMemberRecords { get; set; } = new List<XjSectMemberArchiveRecord>();
	...
	public List<XjGuZunArchiveRecord> GuZunRecords { get; set; } = new List<XjGuZunArchiveRecord>();

	public List<XjDaoTuHighRealmContinuityRecord> DaoTuHighRealmContinuityRecords { get; set; } = new List<XjDaoTuHighRealmContinuityRecord>();

	public int GuZunLastGlobalReappearanceYear { get; set; }

	public XjDaoTaiMeritWorldArchiveData DaoTaiMerit { get; set; } = new XjDaoTaiMeritWorldArchiveData();

	public List<XjWorldHistoryArchiveRecord> WorldHistoryRecords { get; set; } = new List<XjWorldHistoryArchiveRecord>();

	public List<XjSwordIntentArchiveRecord> SwordIntentRecords { get; set; } = new List<XjSwordIntentArchiveRecord>();

	public XjFuQiSwordWorldArchiveData FuQiSwordWorld { get; set; } = new XjFuQiSwordWorldArchiveData();

	public List<XjDaoTuManifestArchiveData> DaoTuManifestRecords { get; set; } = new List<XjDaoTuManifestArchiveData>();
	...
	public XjOpeningLifespanEventArchiveData OpeningLifespanEvent { get; set; } = new XjOpeningLifespanEventArchiveData();

	// 124及更早RC存档兼容字段；1.0 RC4起不再驱动任何玩法。
	public XjTaiYuanJinXianEventArchiveData TaiYuanJinXianEvent { get; set; } = new XjTaiYuanJinXianEventArchiveData();

	public XjYuanZhaoKongZhengEventArchiveData YuanZhaoKongZhengEvent { get; set; } = new XjYuanZhaoKongZhengEventArchiveData();

	public XjShiOpeningPrologueArchiveData ShiOpeningPrologue { get; set; } = new XjShiOpeningPrologueArchiveData();

	public XjEventDongTianWorldArchiveData EventDongTian { get; set; } = new XjEventDongTianWorldArchiveData();
	...
	public List<XjModuleArchiveDocument> ModuleDocuments { get; set; } = new List<XjModuleArchiveDocument>();
}
...
internal sealed class XjWorldArchiveQuanBingStruggleState
{
	...
	public int PhaseStartedYear { get; set; }
	public int PhaseEndYearExclusive { get; set; }
	public int CooldownEndYear { get; set; }
	public int Tension { get; set; }
	public int ProxyConflictCount { get; set; }
...
internal sealed class XjWorldArchiveReincarnationRecord
{
	...
	// 服气金性转世的扩展继承数据。保持为单个 JSON 字符串，避免为普通
	// 金丹转世扩张大量长期无用的存档字段。
	public string FuQiPayload { get; set; } = string.Empty;
...
internal sealed class XjLongShuPopulationArchiveData
{
	...
	public bool OriginPreludeRecorded { get; set; }
	...
	public int HeShuiInfluenceStage { get; set; }
}
...
internal static class XjWorldArchiveCodec
{
	...
	internal static bool TryDecode(string raw, out XjWorldArchiveData data)
	{
		...
		try
		{
			...
			decoded.DaoTaiMerit ??= new XuanJianVNext.Data.HighRealm.XjDaoTaiMeritWorldArchiveData();
			...
			decoded.SectMemberRecords ??= new System.Collections.Generic.List<XuanJianVNext.Data.Sect.XjSectMemberArchiveRecord>();
			...
			decoded.GuZunRecords ??= new System.Collections.Generic.List<XuanJianVNext.Data.HighRealm.XjGuZunArchiveRecord>();
			decoded.DaoTuHighRealmContinuityRecords ??= new System.Collections.Generic.List<XuanJianVNext.Data.HighRealm.XjDaoTuHighRealmContinuityRecord>();
			...
			decoded.OpeningLifespanEvent ??= new XuanJianVNext.Data.Events.XjOpeningLifespanEventArchiveData();
			decoded.TaiYuanJinXianEvent ??= new XuanJianVNext.Data.Events.XjTaiYuanJinXianEventArchiveData();
			decoded.YuanZhaoKongZhengEvent ??= new XuanJianVNext.Data.Events.XjYuanZhaoKongZhengEventArchiveData();
			decoded.ShiOpeningPrologue ??= new XuanJianVNext.Data.Events.XjShiOpeningPrologueArchiveData();
			...
			decoded.ModuleDocuments ??= new System.Collections.Generic.List<XjModuleArchiveDocument>();
			data = decoded;
			return true;
		}
		catch (System.Exception xjCaughtArchiveDecode)
		{
			XuanJianVNext.Core.XjExceptionDiagnostics.Report("code/XuanJianVNext/Data/Archive/XjWorldArchiveData.cs:610", xjCaughtArchiveDecode);
			data = new XjWorldArchiveData();
			return false;
		}
	}
