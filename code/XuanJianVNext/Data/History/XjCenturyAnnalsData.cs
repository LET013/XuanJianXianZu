...
internal static class XjCenturyAnnalsSchema
{
	...
	// 百年世谱与所有“玄鉴历”共用同一持久起录年。内部仍保存绝对世界年；
	// 卷次按 BaseWorldYear 起算：起录当年为玄鉴历1年，第1卷覆盖1-100年。
	...
	internal const int MaxEventIdsPerRecord = 64;
	internal const int MaxNotableEventsPerCentury = 48;
...
internal sealed class XjCenturyAnnalsArchiveRecord
{
	...
	public List<XjCenturyEventRecord> NotableEvents { get; set; } = new List<XjCenturyEventRecord>();
...
internal sealed class XjCenturyEventRecord
{
