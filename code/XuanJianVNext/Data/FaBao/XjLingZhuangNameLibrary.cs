...
internal static class XjLingZhuangNameLibrary
{
	...
	private static readonly string[] AmuletNameSuffixes = { "链", "坠", "佩" };
	...
	internal static bool TryResolveEquipmentTypeFromKind(string kind, out EquipmentType equipmentType)
	{
		...
		if (string.Equals(value, "灵链", StringComparison.Ordinal)
			|| string.Equals(value, "灵符", StringComparison.Ordinal))
		{
