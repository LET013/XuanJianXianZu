...
private static string ResolveCaiQiIconPath(string name, string daoTu)
	{
		...
		if (HasToken(text, "鸺葵")) return "GameResources/item/caiqi/iconResXiaoKuiZhiQi.png";
		if (HasToken(text, "上巫")) return "GameResources/item/caiqi/iconResShangWuZhiQi.png";
		if (HasToken(text, "玉真")) return "GameResources/item/caiqi/iconResYuZhenZhiQi.png";
		if (HasToken(text, "衡祝")) return "GameResources/item/caiqi/iconResHengZhuZhiQi.png";
		if (HasToken(text, "青宣")) return "GameResources/item/caiqi/iconResQingXuanZhiQi.png";
		if (HasToken(text, "全丹")) return "GameResources/item/caiqi/iconResQuanDanZhiQi.png";
		if (HasToken(text, "执孛")) return "GameResources/item/caiqi/iconResZhiBoZhiQi.png";
		if (HasToken(text, "司天")) return "GameResources/item/caiqi/iconResSiTianZhiQi.png";
		if (HasToken(text, "都卫")) return "GameResources/item/caiqi/iconResDuWeiZhiQi.png";
		if (HasToken(text, "渊照")) return "GameResources/item/caiqi/iconResYuanZhaoZhiQi.png";
		if (HasToken(text, "虹霞")) return "GameResources/item/caiqi/iconResHongXiaZhiQi.png";
