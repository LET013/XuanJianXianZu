...
internal static class XjShenBingWindow
{
	...
	private static readonly string[] FilterOptions = { "全部器物", "攻击类", "防御类", "附属类", "筑基法器", "紫府灵宝", "金丹法宝" };
	...
	private static void UpdateCard(GameObject obj, XjFaBaoRankEntry entry, int rank)
	{
		...
		string tierColor = entry.IsJinDan ? "#FFD36A" : entry.IsFaQi ? "#69B7FF" : "#C65CFF";
		string tierName = entry.IsJinDan ? "金丹" : entry.IsFaQi ? "筑基" : "紫府";
