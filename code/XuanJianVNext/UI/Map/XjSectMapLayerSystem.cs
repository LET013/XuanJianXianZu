...
namespace XuanJianVNext.UI.Map;
...
internal static class XjSectMapLayerSystem
{
	...
	internal static void EnableFromCodex()
	{
		_enabled = true;
		SetOptionState(true);
	...
	internal static Color32 ResolveDisplayColor(long sectId)
	{
		return ResolveSectColor(sectId);
	}
	...
	private static void RegisterPowerLocalization()
	{
		...
		catch (System.Exception xjCaught146) { XuanJianVNext.Core.XjExceptionDiagnostics.Report("code/XuanJianVNext/UI/Map/XjSectMapLayerSystem.cs:146", xjCaught146); }
	}
	...
	private static void ClearSelectedPowerButton()
	{
		...
		catch (System.Exception xjCaught199) { XuanJianVNext.Core.XjExceptionDiagnostics.Report("code/XuanJianVNext/UI/Map/XjSectMapLayerSystem.cs:199", xjCaught199); }
	}
	...
	private static void SetOptionState(bool enabled)
	{
		...
		catch (System.Exception xjCaught214) { XuanJianVNext.Core.XjExceptionDiagnostics.Report("code/XuanJianVNext/UI/Map/XjSectMapLayerSystem.cs:214", xjCaught214); }
	}
	...
	private static void ClearHoveredSect()
	{
		...
		catch (System.Exception xjCaught312) { XuanJianVNext.Core.XjExceptionDiagnostics.Report("code/XuanJianVNext/UI/Map/XjSectMapLayerSystem.cs:312", xjCaught312); }
	}
